    ...
    <div className="w-full p-10 flex flex-row justify-center items-center gap-5">
      ...
      <div className="w-1/2  h-full pt-20   flex flex-col justify-center items-center bg-[#7ED957] rounded-lg gap-16">
        ...
        <div className=" flex flex-col justify-center items-center gap-4">
          ...
          <button className="w-[400px] h-[55px] bg-[#173e1f] mt-5 rounded-3xl font-semibold text-2xl text-white">
            Sign up
          </button>
        </div>
        ...
        <div className="flex flex-row justify-center items-center w-full">
          ...
          <span className="w-[110px] text-sm flex justify-center items-center">
            or continue with
          </span>
          <div className="border w-[calc(50%-55px)] h-0  border-b-0 border-t-[#173e1f] border-dashed"></div>
        </div>
